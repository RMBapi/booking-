  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "gap-4 border border-border-subtle bg-surface p-6 shadow-2xl shadow-black/10",
    ...
    >
      ...
      <DialogPrimitive.Close className={cn(
        "absolute right-4 top-4 rounded-lg p-2 text-text-tertiary transition-colors",
        "hover:text-text-primary hover:bg-subtle",
        "focus:outline-none focus:ring-2 focus:ring-primary-100 disabled:pointer-events-none",
      )}>
        <X className="h-4 w-4" />
