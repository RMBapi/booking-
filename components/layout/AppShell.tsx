...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    label: "Services",
    feature: "view_services",
    icon: Wrench,
  },
  {
    href: (id) => `/app/${id}/reviews`,
    label: "Reviews",
  ...
  },
  {
    ...
    label: "Providers",
    feature: "view_providers",
    icon: UsersRound,
  },
  {
    href: (id) => `/app/${id}/analytics`,
    label: "Analytics",
...
const MOCK_NOTIFICATIONS = [
  ...
  {
    id: 2,
    title: "John updated his availability",
    time: "1h ago",
    unread: true,
  },
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  // Close mobile drawer and header menus on route change
  useEffect(() => {
    setMobileOpen(false);
  ...
  return (
    <div className="min-h-screen bg-canvas">
      ...
      >
        {/* Top bar */}
        <header className="sticky top-0 z-40 bg-surface/60 backdrop-blur-2xl saturate-150 border-b border-border-subtle">
            ...
            <div className="flex items-center gap-1">
                  ...
                  {MOCK_NOTIFICATIONS.map((n) => (
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[11px] text-text-tertiary mt-0.5 tabular">
                          {n.time}
                        </p>
                      </div>
                    </li>
              ...
              >
                <div className="px-3 py-3 border-b border-border-subtle">
                  <p className="text-[11px] uppercase tracking-wider text-text-quaternary font-medium">
                    Signed in as
                  </p>
